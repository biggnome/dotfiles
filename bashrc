...
# enable color support of ls & man and also add handy aliases
...
export LESS_TERMCAP_so=$(tput bold; tput setaf 0; tput setab 7) # black on light grey
export LESS_TERMCAP_se=$(tput rmso; tput sgr0)
export LESS_TERMCAP_us=$(tput bold; tput setaf 6) # cyan
